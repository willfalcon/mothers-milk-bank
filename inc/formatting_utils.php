...
function format_phone( $phone, $html = true, $extension_prefix = 'ext. ') {
	$hide_us_code = true;
	// $display_format = '%1$d (%2$d) %3$d-%4$d';
	$display_format = '%2$d-%3$d-%4$d';
	...
	// The actual phone number to display
        $display = sprintf('%d-%d-%d', $matches[2], $matches[3], $matches[4]);
	$output .= $display;
